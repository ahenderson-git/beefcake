    ...
    <div class="ide-layout" data-testid="python-ide-view">
      <div class="ide-main">
        <div class="ide-toolbar" data-testid="python-ide-toolbar">
          ...
          <div class="ide-actions">
            <button id="btn-run-py" class="btn-primary btn-small" data-testid="python-ide-run-button"><i class="ph ph-play"></i> Run Script</button>
            <button id="btn-clear-py" class="btn-secondary btn-small" data-testid="python-ide-clear-button">Clear</button>
            <button id="btn-export-py" class="btn-secondary btn-small" title="Export Result" data-testid="python-ide-export-button"><i class="ph ph-export"></i></button>
            <button id="btn-load-py" class="btn-secondary btn-small" title="Load Script" data-testid="python-ide-load-button"><i class="ph ph-folder-open"></i></button>
            <button id="btn-save-py" class="btn-secondary btn-small" title="Save Script" data-testid="python-ide-save-button"><i class="ph ph-floppy-disk"></i></button>
            <button id="btn-install-polars" class="btn-secondary btn-small" data-testid="python-ide-install-button"><i class="ph ph-package"></i> Install Polars</button>
            ${showRefactorBtn ? `<button id="btn-refactor-py" class="btn-secondary btn-small" title="Update column names in script to match selected stage" data-testid="python-ide-refactor-button"><i class="ph ph-arrows-counter-clockwise"></i> Refactor</button>` : ''}
            ${renderStageSelector(state, 'python')}
            <div class="font-controls">
              <button id="btn-dec-font-py" class="btn-secondary btn-small" data-testid="python-ide-dec-font-button"><i class="ph ph-minus"></i></button>
              <span id="py-font-size-label" data-testid="python-ide-font-size">${fontSize}</span>
              <button id="btn-inc-font-py" class="btn-secondary btn-small" data-testid="python-ide-inc-font-button"><i class="ph ph-plus"></i></button>
            </div>
          </div>
        </div>
        ...
        <div class="ide-output" data-testid="python-ide-output-panel">
          <div class="output-header">
            Console Output
            <button id="btn-copy-output-py" class="btn-ghost btn-xs" title="Copy output to clipboard" style="float: right;" data-testid="python-ide-copy-button">
    ...
    <div class="ide-layout" data-testid="sql-ide-view">
      <div class="ide-main">
        <div class="ide-toolbar" data-testid="sql-ide-toolbar">
          ...
          <div class="ide-actions">
            <button id="btn-run-sql" class="btn-primary btn-small" data-testid="sql-ide-run-button"><i class="ph ph-play"></i> Execute Query</button>
            <button id="btn-clear-sql" class="btn-secondary btn-small" data-testid="sql-ide-clear-button">Clear</button>
            <button id="btn-export-sql" class="btn-secondary btn-small" title="Export Result" data-testid="sql-ide-export-button"><i class="ph ph-export"></i></button>
            <button id="btn-load-sql" class="btn-secondary btn-small" title="Load Query" data-testid="sql-ide-load-button"><i class="ph ph-folder-open"></i></button>
            <button id="btn-save-sql" class="btn-secondary btn-small" title="Save Query" data-testid="sql-ide-save-button"><i class="ph ph-floppy-disk"></i></button>
            <button id="btn-install-polars" class="btn-secondary btn-small" data-testid="sql-ide-install-button"><i class="ph ph-package"></i> Install Polars</button>
            <button id="btn-sql-docs" class="btn-secondary btn-small" title="Polars SQL Docs" data-testid="sql-ide-docs-button"><i class="ph ph-question"></i></button>
            ${showRefactorBtn ? `<button id="btn-refactor-sql" class="btn-secondary btn-small" title="Update column names in query to match selected stage" data-testid="sql-ide-refactor-button"><i class="ph ph-arrows-counter-clockwise"></i> Refactor</button>` : ''}
            ${renderStageSelector(state, 'sql')}
            <div class="font-controls">
              <button id="btn-dec-font-sql" class="btn-secondary btn-small" data-testid="sql-ide-dec-font-button"><i class="ph ph-minus"></i></button>
              <span id="sql-font-size-label" data-testid="sql-ide-font-size">${fontSize}</span>
              <button id="btn-inc-font-sql" class="btn-secondary btn-small" data-testid="sql-ide-inc-font-button"><i class="ph ph-plus"></i></button>
            </div>
          </div>
        </div>
        ...
        <div class="ide-output" data-testid="sql-ide-output-panel">
          <div class="output-header">
            Result Set
            <button id="btn-copy-output-sql" class="btn-ghost btn-xs" title="Copy output to clipboard" style="float: right;" data-testid="sql-ide-copy-button">
              <i class="ph ph-copy"></i>
            </button>
          </div>
