...
export class StepConfigPanel {
    ...
    private attachDropColumnsListeners(): void {
        ...
        input?.addEventListener('blur', () => {
            ...
            const columns = columnsText ? columnsText.split(',').map(c => c.trim()).filter(c => c) : [];
    ...
    private attachImputeListeners(): void {
        const strategySelect = this.container.querySelector<HTMLSelectElement>('#impute-strategy-select');
    ...
    private attachNormaliseListeners(): void {
        const methodSelect = this.container.querySelector<HTMLSelectElement>('#normalize-method-select');
        const columnsInput = this.container.querySelector<HTMLTextAreaElement>('#normalize-columns-input');
    ...
    private attachRegexReplaceListeners(): void {
        ...
        const replacementInput = this.container.querySelector<HTMLInputElement>('#regex-replacement-input');
